    ...
    <div class="wrapper">
        ...
        <div class="profile-content section-nude">
            <div class="container">
                <h3>사용자 관리</h3>
                <div>
                    <a href="/admin/user_new" type="button" class="btn btn-sm btn-primary">신규 사용자 등록</a>
                </div>
                <div> 
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?=$user['id']?></td>
                                <td><?=$user['userid']?></td>
                                <td><a href="/admin/user_detail/<?=$user['id']?>" type="button" class="btn btn-xs btn-primary">상세 보기</a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
