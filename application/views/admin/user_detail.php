                    ...
                    <form class="contact-form">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <a href="/admin/user" class="btn btn-normal btn btn-fill">리스트</a>
                                <a href="javascript:confirm_delete(<?=$user['id']?>);" class="btn btn-danger btn btn-fill pull-right">삭제</a>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
    function confirm_delete(id){
        if(confirm("정말 삭제하시겠습니까?")){
            document.location.href = "/admin/user_delete/"+id;
        }
    }
</script>
