                    ...
                    <form class="contact-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>카드</label>
                                <div>
                                <img class="form-control-static" src="<?=$card['image']?>"/>
                                <p class="form-control-static"><?=$card['title']?></p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>설명</label>
                                <textarea class="form-control" rows="4" readonly="readonly"><?=$card['description']?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <a href="/admin/show_qrcode/<?=$card['code']?>" target="_blank" class="btn btn-primary btn btn-fill">QR Code 보기</a>
                                <a href="/admin/card" class="btn btn-normal btn btn-fill">리스트</a>
                                <a href="javascript:confirm_delete(<?=$card['id']?>);" class="btn btn-danger btn btn-fill pull-right">삭제</a>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
    function confirm_delete(id){
        if(confirm("정말 삭제하시겠습니까?")){
            document.location.href = "/admin/card_delete/"+id;
        }
    }
</script>
